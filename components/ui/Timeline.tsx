...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      className="w-full bg-tranparent font-sans md:px-10"
      ref={containerRef}
    >
      <div className="max-w-7xl mx-auto py-[4rem] px-4 md:px-8 lg:px-10">
        <h2 className="text-lg mt-[3rem] md:text-4xl mb-4 text-black font-semibold dark:text-white max-w-4xl">
         Learning, Building, and Designing as a Developer
        </h2>
        <p className="text-neutral-700 dark:text-neutral-300 text-sm md:text-base max-w-sm">
          I&apos;ve been coding and developing for the past 3 years. Here&apos;s
